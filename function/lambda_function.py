...
# TODO: Handle InvalidAMIID.NotFound exceptions
...
def complete(body):
    ...
    try:
        ...
        return {
            "statusCode": 200,
            "body": json.dumps(f"Successfully added AMI metadata tags."),
        }
    ...
    try:
        ...
        for ami in amis:
            ...
            ec2_client.create_tags(
                Resources=[ami_id],
                Tags=[
                    {"Key": "DeprecationTime", "Value": deprecation_time.isoformat()},
                    {
        ...
        return {
            "statusCode": 200,
            "body": json.dumps(
                f"Successfully set deprecation time to {deprecation_time}."
            ),
        }
...
def delete(body):
    ...
    try:
        ...
        for ami in amis:
            ...
            # Describe the snapshots associated with the AMI
        ...
        return {
            "statusCode": 200,
            "body": json.dumps(
                f"Successfully deregistered AMI(s) and deleted associated snapshot(s)."
            ),
        }
...
def restore(body):
    ...
    try:
        ...
        for ami in amis:
            ...
            ec2_client.disable_image_deprecation(ImageId=ami["id"], DryRun=False)
        ...
        return {
            "statusCode": 200,
            "body": json.dumps(f"AMI deprecation disabled."),
        }
